...
import (
	...
	models "github.com/nuonco/terraform-provider-nuon/internal/api/client/models"
)
...
func (m *MockClient) GetAppReleases(ctx context.Context, componentID string) ([]*models.AppComponentRelease, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetAppReleases", ctx, componentID)
	ret0, _ := ret[0].([]*models.AppComponentRelease)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockClientMockRecorder) GetAppReleases(ctx, componentID interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetAppReleases", reflect.TypeOf((*MockClient)(nil).GetAppReleases), ctx, componentID)
}
